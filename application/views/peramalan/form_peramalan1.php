	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<form action="<?= base_url() ?>peramalan/hasil_peramalan1" method="post"
							...
							<div class="col-sm-9">
								<div class="form-check">
									<label class="form-check-label" style="font-weight: normal;">
										<input name="bulan" id="bulan" type="radio" required="required" 
											class="form-check-input flat" value="<?= date($tahun_depan."-".$bulan_depan); ?>">
