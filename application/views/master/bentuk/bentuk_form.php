<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_content">
            ...
            <form action="<?= site_url('bentuk/process') ?>" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Name bentuk <span class="required text-danger">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="hidden" name="id" value="<?= $row->bentuk_id?>">
