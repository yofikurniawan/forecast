<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Data Category<small>Obat</small></h2>
                ...
                <a href=<?=site_url('category/add_category') ?> class="btn btn-primary btn-sm" >
                    <i class="glyphicon glyphicon-ok"></i> Create Category Obat
                </a> 
                <?php } ?>
                </ul>
                ...
                <div class="container-fluid mt-3">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                Untuk menambahkan, mengubah dan menghapus category data obat harap melaporkan dulu ke pemliki apotek (admin) atau Asisten
                                apotek.
                            </td>
                        </tr>
                        <tr>
