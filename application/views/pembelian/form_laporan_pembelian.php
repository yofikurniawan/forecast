<div class="page-content x_panel">
	<div class="row">
		<div class="col-6">
			<h4>Form Laporan Pembelian obat</h4>
		</div>
	</div>
		<div class="container-fluid x_panel">
		    <div class="row">
                <div class="text-right">
				<h5><i class="fa fa-list-alt col-6 text-center"></i> Lengkapi form ini untuk mencetak laporan pembelian</h5>
                </div>
                <div class="col-md-6 col-md-offset-3">
				<form action="" method="POST" target="blank" id="form_laporanpembelian"  class="x_panel">
					<div class="form-group row">
						<label for="periode_lap" class="col-sm-3 col-form-label">Pilih Periode</label>
						<div class="col-sm-3">
							<div class="form-check">
								<label class="form-check-label" style="font-weight: normal;">
									<input name="periode_lap" id="per_1" type="radio" class="form-check-input"
							...
							<div class="form-check">
								<label class="form-check-label" style="font-weight: normal;">
									<input name="periode_lap" id="per_2" type="radio" class="form-check-input"
										value="bulan_ini">
									Bulan ini
								</label>
							</div>
							<div class="form-check">
								<label class="form-check-label" style="font-weight: normal;">
									<input name="periode_lap" id="per_3" type="radio" class="form-check-input"
										value="tahun_ini">
									Tahun ini
								</label>
							</div>
						...
						<div class="col-sm-3">
							<div class="form-check">
								<label class="form-check-label" style="font-weight: normal;">
									<input name="periode_lap" id="per_4" type="radio" class="form-check-input"
										value="pertanggal">
									Per Tanggal
								</label>
							</div>
							<div class="form-check">
								<label class="form-check-label" style="font-weight: normal;">
									<input name="periode_lap" id="per_5" type="radio" class="form-check-input"
										value="perbulan">
									Per Bulan
								</label>
							</div>
							<div class="form-check">
								<label class="form-check-label" style="font-weight: normal;">
									<input name="periode_lap" id="per_6" type="radio" class="form-check-input"
										value="pertahun">
									Per Tahun
								</label>
							</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<select name="nm_supplier" id="nm_supplier" class="form-control form-control-sm">
                                ...
                                <?php 
                                    $sql_supp = $this->db->query("SELECT supplier_id, name FROM supplier ORDER BY name ASC");
                                    foreach($sql_supp->result_array() as $data_supp): 
					            ?>
								<option value="<?php echo $data_supp['supplier_id']; ?>"><?php echo $data_supp['name']; ?></option>
					            <?php endforeach ?>
							</select>
						</div>
					</div>
...
<script>
	...
	function cetak(action) {
		...
		$.ajax({
			url: '<?php echo site_url('pembelian/cek_laporan'); ?>',
			method: 'POST',
			data: form_data,
	...
	$("#tbl_cetakdetail").click(function () {
		cetak('<?php echo site_url('pembelian/laporan_pembelian_detail'); ?>');
	});
	$("#tbl_cetakrangkuman").click(function () {
		cetak('<?php echo site_url('pembelian/laporan_pembelian_rangkuman'); ?>');
	});
</script>
